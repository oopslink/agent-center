    ...
    },
    {
      ...
      "tools": [
        ...
        },
        {
          ...
          "summary": "List a cycle plan's UNMERGED feature branches = its Integrate nodes that are not yet done (each branch not yet merged back into the integration trunk).",
        ...
        },
        {
          ...
          "summary": "Build a whole cycle CONTROL-FLOW graph in one call: S0 (cut dev/\u003cversion\u003e) → for each feature a Dev→Review→Decision chain where the Decision routes pass→Integrate and reject→a bounded loopback back to Dev (max_review_rounds, default 3; on exhaustion → an escape/人工兜底 node) → 集成完成 Gate (barrier) → Accept → Ship.",
