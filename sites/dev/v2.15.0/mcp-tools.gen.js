  ...
  "domains": [
    ...
    },
    {
      ...
      "tools": [
        ...
        },
        {
          ...
          "summary": "Supervisor-first control view.",
    ...
    },
    {
      ...
      "tools": [
        ...
        {
          "name": "reset_task",
          "summary": "Tier-3 recovery for a task stranded RUNNING under this Agent's dead/stale executor (its workspace/worktree is gone, node changed, or get_task_execution reports recovery_required): reset it back to the pool (running→open, assignee/lease cleared).",
        ...
        },
        {
          ...
          "summary": "Retry a standalone failed task by returning it to open for a fresh attempt.",
    ...
    },
    {
      ...
      "tools": [
        ...
        },
        {
          ...
          "summary": "Read the current or terminal status for a prior runtime_deploy_restart attempt by idempotency_key.",
