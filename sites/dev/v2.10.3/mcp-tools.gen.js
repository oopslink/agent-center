  ...
  "domains": [
    ...
    },
    {
      ...
      "tools": [
        ...
        {
          "name": "start_plan",
          "summary": "Validate and start a pending plan (move it to running).",
    ...
    },
    {
      ...
      "tools": [
        ...
        },
        {
          ...
          "summary": "Atomically edit a plan's DAG with a batch of ops — the SINGLE topology-edit entrypoint, for PENDING and RUNNING plans alike.",
        ...
        {
          "name": "get_team_rules",
          "summary": "Read the enabled Team Memory rules for the current agent's team and phase (plan, execute, review, recovery).",
