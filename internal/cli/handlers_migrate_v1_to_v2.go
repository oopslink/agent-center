...
// 0122 adds the explicit task delivery contract; 0123 adds controlled Team Memory
// policy; 0124 makes worker control command status observable; 0125 checkpoints
