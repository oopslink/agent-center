...
func (a *App) issueOpenHandler(fs *flag.FlagSet) Handler {
	...
	return func(ctx context.Context, args []string, out, errw io.Writer) ExitCode {
		...
		if a.Client != nil {
			...
			res, derr := a.IssueLifecycleSvc.Open(ctx, disservice.OpenIssueCommand{
				ProjectID:          projectID,
				Title:              title,
				Description:        *description,
...
func (a *App) issueCommentHandler(fs *flag.FlagSet) Handler {
	...
	return func(ctx context.Context, args []string, out, errw io.Writer) ExitCode {
		...
		if a.Client != nil {
			...
			res, cerr := a.IssueCommentSvc.Comment(ctx, disservice.CommentInput{
...
func (a *App) issueConcludeHandler(fs *flag.FlagSet) Handler {
	...
	return func(ctx context.Context, args []string, out, errw io.Writer) ExitCode {
		...
		if a.Client != nil {
			...
			res, cerr := a.IssueLifecycleSvc.Conclude(ctx, disservice.ConcludeIssueCommand{
				IssueID:     discussion.IssueID(args[0]),
...
func (a *App) issueWithdrawHandler(fs *flag.FlagSet) Handler {
	...
	return func(ctx context.Context, args []string, out, errw io.Writer) ExitCode {
		...
		if a.Client != nil {
			...
			if _, werr := a.IssueLifecycleSvc.Withdraw(ctx, disservice.WithdrawIssueCommand{
				IssueID:     discussion.IssueID(args[0]),
				Reason:      *reason,
				Message:     *message,
				WithdrawnBy: by,
				...
				return HandleDomainError(errw, *format, werr)
			}
		}
		if *format == "json" {
