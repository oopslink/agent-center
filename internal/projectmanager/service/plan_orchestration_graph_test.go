...
func planGraphSetup(t *testing.T) (*planAdvanceHarness, *orch.Service) {
	...
	h := &planAdvanceHarness{rawDB: db, svc: svc, plans: plans, tasks: tasks, convRepo: convRepo, msgRepo: msgRepo, relay: relay, clk: clk, actionLogs: actionLogs, audit: auditRepo, ctx: context.Background()}
	return h, orchSvc
}
