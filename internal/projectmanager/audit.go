...
const (
	...
	AuditPlanOwnerTransferred  AuditChangeType = "owner_transferred"
	AuditPlanBlockCreated      AuditChangeType = "block_created"
	AuditPlanBlockAcknowledged AuditChangeType = "block_acknowledged"
	AuditPlanBlockResolved     AuditChangeType = "block_resolved"
