...
var (
	...
	ErrPlanOwnerOnly              = errors.New("projectmanager: only the current plan owner may perform this action")
	ErrPlanBlockEventNotFound     = errors.New("projectmanager: plan block event not found")
	ErrInvalidPlanBlockResolution = errors.New("projectmanager: invalid plan block resolution kind")
	ErrPlanBlockStillBlocked      = errors.New("projectmanager: plan block resolution left the task blocked")
