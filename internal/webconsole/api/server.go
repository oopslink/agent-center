...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("GET /api/orgs/{slug}/insights/v2/projects", s.insightsV2ProjectsHandler)
	s.mux.HandleFunc("GET /api/orgs/{slug}/insights/v2/projects/{project_id}", s.insightsV2ProjectHandler)
	s.mux.HandleFunc("GET /api/orgs/{slug}/insights/v2/projects/{project_id}/delivery", s.insightsV2ProjectDeliveryHandler)
	s.mux.HandleFunc("GET /api/orgs/{slug}/insights/v2/projects/{project_id}/lifecycle", s.insightsV2ProjectLifecycleHandler)
	s.mux.HandleFunc("GET /api/orgs/{slug}/insights/v2/projects/{project_id}/evolution", s.insightsV2ProjectEvolutionHandler)
	s.mux.HandleFunc("GET /api/orgs/{slug}/insights/v2/projects/{project_id}/plans/{plan_id}/lineage", s.insightsV2PlanLineageHandler)
	s.mux.HandleFunc("GET /api/orgs/{slug}/insights/v2/executions", s.insightsV2ExecutionsHandler)
	s.mux.HandleFunc("GET /api/orgs/{slug}/insights/v2/executions/{execution_id}", s.insightsV2ExecutionHandler)
	...
	s.mux.HandleFunc("DELETE /api/orgs/{slug}/ai-runtime/clis/{id}", s.deleteRuntimeCLIHandler)
	...
	s.mux.HandleFunc("DELETE /api/orgs/{slug}/ai-runtime/models/{id}", s.deleteRuntimeModelHandler)
	...
	s.mux.HandleFunc("GET /api/orgs/{slug}/teams/{id}/roles/{role}/delete-impact", s.previewDeleteTeamRoleHandler)
	s.mux.HandleFunc("DELETE /api/orgs/{slug}/teams/{id}/roles/{role}", s.deleteTeamRoleHandler)
	...
	s.mux.HandleFunc("PUT /api/orgs/{slug}/teams/{id}/memory/settings", s.putTeamMemorySettingsHandler)
	s.mux.HandleFunc("POST /api/orgs/{slug}/teams/{id}/memory/proposals", s.createTeamMemoryProposalHandler)
	s.mux.HandleFunc("GET /api/orgs/{slug}/teams/{id}/memory/proposals/{proposal_id}", s.teamMemoryProposalDocHandler)
	s.mux.HandleFunc("POST /api/orgs/{slug}/teams/{id}/memory/proposals/{proposal_id}/promote", s.promoteTeamMemoryProposalHandler)
	s.mux.HandleFunc("POST /api/orgs/{slug}/teams/{id}/memory/proposals/{proposal_id}/reject", s.rejectTeamMemoryProposalHandler)
	...
	s.mux.HandleFunc("POST /api/orgs/{slug}/access/grants/revoke/confirm", s.accessBulkRevokeConfirmHandler)
	...
	s.mux.HandleFunc("POST /api/orgs/{slug}/projects/{project_id}/tasks/{task_id}/fail", s.pmFailTaskHandler)
	...
	s.mux.HandleFunc("POST /api/orgs/{slug}/projects/{project_id}/plans/{plan_id}/reopen", s.pmReopenPlanHandler)
