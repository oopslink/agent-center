...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("POST /api/orgs/{slug}/ai-runtime/shadow-compare", s.shadowCompareRuntimeHandler)
	s.mux.HandleFunc("POST /api/orgs/{slug}/ai-runtime/cutover", s.cutoverRuntimeHandler)
