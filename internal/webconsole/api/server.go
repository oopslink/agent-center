...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("GET /api/orgs/{slug}/permissions/access-graph", s.permissionsAccessGraphHandler)
	s.mux.HandleFunc("GET /api/orgs/{slug}/permissions/graph", s.permissionsAccessGraphHandler)
