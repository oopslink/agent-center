...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("GET /api/orgs/{slug}/ai-runtime/basic-coverage", s.getRuntimeBasicCoverageHandler)
	s.mux.HandleFunc("GET /api/orgs/{slug}/ai-runtime/impact", s.previewRuntimeImpactHandler)
	s.mux.HandleFunc("GET /api/orgs/{slug}/ai-runtime/audit", s.listRuntimeAuditHandler)
