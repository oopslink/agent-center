...
// retryFailedTaskHandler is the explicit retry path for a standalone failed
// task: failed→open, with failed/block/lease/current-delivery state cleared. It
// never reopens plan-bound failures or completed/discarded/running work.
