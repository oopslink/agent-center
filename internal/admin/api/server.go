...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("POST /admin/agent-tools/evolve_plan_generation", s.evolvePlanGenerationHandler)
	s.mux.HandleFunc("POST /admin/agent-tools/transfer_plan_owner", s.transferPlanOwnerHandler)
	s.mux.HandleFunc("POST /admin/agent-tools/list_plan_block_events", s.listPlanBlockEventsHandler)
	s.mux.HandleFunc("POST /admin/agent-tools/acknowledge_plan_block", s.acknowledgePlanBlockHandler)
	s.mux.HandleFunc("POST /admin/agent-tools/resolve_plan_block", s.resolvePlanBlockHandler)
	s.mux.HandleFunc("POST /admin/agent-tools/start_plan", s.startPlanHandler)
	s.mux.HandleFunc("POST /admin/agent-tools/pause_plan", s.pausePlanHandler)
	s.mux.HandleFunc("POST /admin/agent-tools/resume_plan", s.resumePlanHandler)
	s.mux.HandleFunc("POST /admin/agent-tools/reopen_plan", s.reopenPlanHandler)
	s.mux.HandleFunc("POST /admin/agent-tools/complete_plan", s.completePlanHandler)
	s.mux.HandleFunc("POST /admin/agent-tools/discard_plan", s.discardPlanHandler)
	...
	s.mux.HandleFunc("POST /admin/agent-tools/get_team_rule_index", s.getTeamRuleIndexHandler)
	s.mux.HandleFunc("POST /admin/agent-tools/get_team_rule", s.getTeamRuleHandler)
