...
VALUES
    ...
    ('team.create', 'access', '["org"]', '["create"]', '["members"]', datetime('now')),
    ...
    ('template.write', 'access', '["org"]', '["update"]', '["members"]', datetime('now')),
...
VALUES
    ...
    ('sys-org-owner', 'team.create', 'org', 1, datetime('now')),
    ('sys-org-owner', 'template.write', 'org', 1, datetime('now')),
    ...
    ('sys-org-admin', 'team.create', 'org', 0, datetime('now')),
    ('sys-org-admin', 'template.write', 'org', 0, datetime('now')),
    ...
    ('sys-org-member', 'team.create', 'org', 0, datetime('now')),
    ('sys-org-member', 'template.write', 'org', 0, datetime('now')),
