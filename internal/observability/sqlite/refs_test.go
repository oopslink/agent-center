...
// TestEventRepo_Find_FilterByWorkItemID was removed in v2.14.0: the vestigial
// EventRefs/EventRefsFilter.WorkItemID dimension (the old AgentWorkItem-id
// filter) was dropped — it had no producer after the AgentWorkItem model was
// retired and is DISTINCT from task_id.
