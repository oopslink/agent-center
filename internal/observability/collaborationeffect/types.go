...
const (
	...
	RelationAgentPlan         RelationType = "agent_plan"
	RelationPlanTask          RelationType = "plan_task"
	RelationPlanStage         RelationType = "plan_stage"
	RelationStageTask         RelationType = "stage_task"
