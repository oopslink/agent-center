...
// System-level /version page (sibling to Environment / Settings). The wake-chain
// guardrail params panel (MAX_DEPTH / cycle window+N / rate R·min⁻¹ / token
// budget) lands here once D1's settings API (I7-M1) is on main.
