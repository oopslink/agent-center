...
// ChannelDetail page — F3 placeholder. Real implementation lands in a later ST
...
export default function ChannelDetail(): React.ReactElement {
  return (
    <section className="space-y-2" data-testid="page-ChannelDetail">
      <h2 className="text-xl font-semibold">ChannelDetail</h2>
