...
export function runtimeModelAllowsCLI(model: RuntimeModel, cliKey: string | undefined): boolean {
  ...
  // Compatibility is an authority boundary: missing metadata is not permission.
  // A saved desired value can still be rendered as unavailable, but it must not
  // become a selectable option without an explicit compatible CLI.
