    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          {/* Compatibility: the old Workspace model catalog now lands on the
              unified AI Runtime catalog, which is the single model source. */}
          <Route path="model-catalog" element={<Navigate to="../ai-runtime" replace relative="path" />} />
