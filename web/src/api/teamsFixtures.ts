  ...
  const teams: TeamView[] = [
    {
      ...
      version: 3,
      roles: [
        { role: 'planner', count: 1, cli: 'claude-code', model: 'opus-4.8', max_concurrency: 1, capability_tags: [], ram_role_keys: ['Team contributor'], access_requirements: ['team.read', 'team.write', 'team.memory.read', 'team.memory.propose'] },
        { role: 'coder', count: 3, cli: 'claude-code', model: 'sonnet-5', max_concurrency: 2, capability_tags: [], ram_role_keys: ['Team contributor'], access_requirements: ['team.read', 'team.write', 'team.memory.read', 'team.memory.propose'] },
        { role: 'reviewer', count: 1, cli: 'claude-code', model: 'opus-4.8', max_concurrency: 1, capability_tags: [], ram_role_keys: ['Team curator'], access_requirements: ['team.read', 'team.write', 'team.memory.read', 'team.memory.propose', 'team.memory.review'] },
        { role: 'ops', count: 1, cli: 'codex', model: 'gpt-5', max_concurrency: 1, capability_tags: [], ram_role_keys: ['Team basic'], access_requirements: ['team.read', 'team.memory.read'] },
      ],
    },
    {
      id: 'team-4a1f22',
      ...
      version: 1,
      roles: [
        { role: 'planner', count: 1, cli: 'claude-code', model: 'sonnet-5', max_concurrency: 1, capability_tags: [], ram_role_keys: ['Team basic'], access_requirements: ['team.read', 'team.memory.read'] },
        { role: 'coder', count: 2, cli: 'claude-code', model: 'sonnet-5', max_concurrency: 2, capability_tags: [], ram_role_keys: ['Team contributor'], access_requirements: ['team.read', 'team.write', 'team.memory.read', 'team.memory.propose'] },
        { role: 'researcher', count: 1, cli: 'claude-code', model: 'opus-4.8', max_concurrency: 1, capability_tags: [], ram_role_keys: ['Team basic'], access_requirements: ['team.read', 'team.memory.read'] },
      ],
    },
    {
      id: 'team-9b8e01',
