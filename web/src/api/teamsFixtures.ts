...
function seed(): TeamsData {
  ...
  const memoryIndex: MemoryIndexEntry[] = [
    { slug: 'MEMORY.md', pinned: true, kind: 'index', commit: 'commit-base' },
    { group: 'entries/' },
    { slug: 'ci-runbook', kind: 'entry', source_path: 'entries/ci-runbook-uuid-ci.md', uuid: 'uuid-ci', blob_hash: 'blob-ci', commit: 'commit-base' },
    { slug: 'go-error-patterns', kind: 'entry', source_path: 'entries/go-error-patterns-uuid-go.md', uuid: 'uuid-go', blob_hash: 'blob-go', commit: 'commit-base' },
    { slug: 'release-checklist', kind: 'entry', source_path: 'entries/release-checklist-uuid-release.md', uuid: 'uuid-release', blob_hash: 'blob-release', commit: 'commit-base' },
    { group: 'rules/' },
    { slug: 'review-conventions', kind: 'rule', source_path: 'rules/review-conventions-uuid-review.md', uuid: 'uuid-review', blob_hash: 'blob-review', commit: 'commit-base' },
    { slug: 'merge-gate', kind: 'rule', source_path: 'rules/merge-gate-uuid-merge.md', uuid: 'uuid-merge', blob_hash: 'blob-merge', commit: 'commit-base' },
    { group: 'proposals/' },
    { slug: 'proposal-pending-1', kind: 'proposal', proposal_id: 'proposal-pending-1', status: 'pending', operation: 'add', target_kind: 'entry', repo_commit: 'commit-proposal', source_path: 'proposals/proposal-pending-1.yaml' },
  ];
  ...
  const memoryDocs: Record<string, MemoryDoc> = {
    ...
    'ci-runbook': {
      ...
      source_path: 'entries/ci-runbook-uuid-ci.md',
      title: 'CI/CD runbook',
    ...
    'merge-gate': {
      ...
      source_path: 'rules/merge-gate-uuid-merge.md',
      title: '合并门禁',
      frontmatter: 'name: merge-gate\nuuid: uuid-merge\nblob_hash: blob-merge\nupdated: 2026-07-13',
    ...
    'go-error-patterns': {
      ...
      source_path: 'entries/go-error-patterns-uuid-go.md',
      title: 'Go 错误处理约定',
    ...
    'release-checklist': {
      ...
      source_path: 'entries/release-checklist-uuid-release.md',
      title: '发布清单',
      frontmatter: 'name: release-checklist\ntype: project\nuuid: uuid-release\nblob_hash: blob-release\nupdated: 2026-07-12',
    ...
    'proposal-pending-1': {
      slug: 'proposal-pending-1',
      path: 'proposals/proposal-pending-1.yaml',
      source_path: 'proposals/proposal-pending-1.yaml',
      title: 'proposal-pending-1',
      kind: 'proposal',
      frontmatter: 'proposal_id: proposal-pending-1\nstatus: pending\nrepo_commit: commit-proposal',
      body: '## add entry\n\nPending rollback note proposal.',
      repo_commit: 'commit-proposal',
      proposal: {
        team_id: 'team-7c19b0',
        ...
        candidate: {
          ...
          body: 'Rollback through the last green build.',
        },
        rationale: 'Capture rollback practice.',
        evidence_refs: ['task:T1282'],
        author_ref: 'agent:coder-01',
        created_at: '2026-08-09T00:00:00Z',
        idempotency_key: 'fixture:proposal-pending-1',
        status: 'pending',
        warnings: ['warning ack required'],
        source_path: 'proposals/proposal-pending-1.yaml',
        repo_commit: 'commit-proposal',
        diff_preview: '+++ entries/deploy-rollback-uuid-new.md\n+Rollback through the last green build.',
      },
    },
  };
