...
function seed(): TeamsData {
  ...
  const agents: DirectoryAgent[] = [
    { name: 'agent-center-pd', status: 'working', role: 'planner', teams: ['agent-center core'], model: 'opus-4.8', load: 0.4, backlog: 1, last: 'now' },
    { name: 'agent-center-dev1', status: 'idle', role: 'coder', teams: ['agent-center core'], model: 'sonnet-5', load: 0.0, backlog: 0, last: '2m' },
    { name: 'agent-center-dev2', status: 'idle', role: 'coder', teams: ['agent-center core'], model: 'sonnet-5', load: 0.0, backlog: 0, last: '5m' },
    { name: 'agent-center-dev3', status: 'idle', role: 'coder', teams: ['agent-center core'], model: 'sonnet-5', load: 0.0, backlog: 0, last: '8m' },
    { name: 'agent-center-tester1', status: 'idle', role: 'reviewer', teams: ['agent-center core'], model: 'opus-4.8', load: 0.0, backlog: 0, last: '12m' },
    { name: 'agent-center-tester2', status: 'idle', role: 'reviewer', teams: ['growth-experiments'], model: 'sonnet-5', load: 0.0, backlog: 0, last: '20m' },
    { name: 'agent-center-tester3', status: 'idle', role: 'researcher', teams: ['growth-experiments'], model: 'opus-4.8', load: 0.0, backlog: 0, last: '25m' },
    { name: 'agent-center-dev4', status: 'idle', role: 'coder', teams: ['growth-experiments'], model: 'sonnet-5', load: 0.0, backlog: 0, last: '31m' },
    { name: 'agent-center-dev5', status: 'idle', role: 'coder', teams: [], model: 'sonnet-5', load: 0.0, backlog: 0, last: '1h' },
    { name: 'agent-center-integration-d', status: 'idle', role: 'ops', teams: [], model: 'gpt-5', load: 0.0, backlog: 0, last: '2h' },
    { name: 'UDE', status: 'working', role: 'designer', teams: ['docs-and-dx'], model: 'opus-4.8', load: 0.6, backlog: 2, last: 'now' },
  ];

  const humans: DirectoryHuman[] = [
    { name: 'oopslink', role: 'owner', status: 'Joined', email: 'oopslink@abc.com', created: '2026/6/4', last: '2026/7/13', teams: ['agent-center core', 'growth-experiments', 'docs-and-dx'] },
    { name: 'alice', role: 'member', status: 'Joined', email: 'alice@abc.com', created: '2026/6/18', last: '1h', teams: ['agent-center core', 'growth-experiments'] },
    { name: 'bob', role: 'member', status: 'Joined', email: 'bob@abc.com', created: '2026/6/25', last: '3h', teams: ['docs-and-dx'] },
    { name: 'carol', role: 'member', status: 'Invited', email: 'carol@abc.com', created: '2026/7/9', last: '—', teams: [] },
  ];
