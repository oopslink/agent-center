...
- 依据：[03-issue-discussion](../tactical/discussion/01-issue-discussion.md) + [12-conversation](../tactical/conversation/01-conversation.md) + [ADR-0007](../../decisions/0007-conversation-as-unified-session.md)（Conversation 作统一会话层）+ IM-first 设计
