...
| ~~**Identity（身份）**~~ | ~~Conversation~~ | ~~v2.6 前归属 Conversation BC；v2.6 起已独立为 Identity BC（ADR-0040），见上方 Identity 行~~ |
...
**详细设计**: [cognition/00-overview.md](../tactical/cognition/00-overview.md)（BC 入口）+ [01-supervisor-invocation.md](../tactical/cognition/01-supervisor-invocation.md) + [02-memory.md](../tactical/cognition/02-memory.md)
...
| ~~TaskRuntime~~ | ~~`taskruntime`~~ | ~~`task.*` / `task_execution.*`~~ | RETIRED v2.7 → ProjectManager |
| ~~Discussion~~ | ~~`discussion`~~ | ~~`issue.*`~~ | RETIRED v2.7 → ProjectManager |
