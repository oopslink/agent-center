...
~~详见 [bridge/01-feishu-integration.md] — 已删 per ADR-0031~~ → 见 [~~tactical/bridge/* (v2 deleted per ADR-0031)~~](../../../decisions/drafts/0031-v2-drop-bridge-vendor-integration.md)。
...
- ~~[bridge/01-feishu-integration.md] — Proposal 飞书卡片渲染~~ → [~~tactical/bridge/* (v2 deleted per ADR-0031)~~](../../../decisions/drafts/0031-v2-drop-bridge-vendor-integration.md)
