...
| **AgentInstanceConfig** | AgentInstance.config 字段（JSON）| `{ instructions_ref?, mcp_config?, skills?, ... }`；G1 仅约定 instructions；G4/G5 后续填字段（[ADR-0024](../../../decisions/drafts/0024-agent-instance-first-class.md)）|
