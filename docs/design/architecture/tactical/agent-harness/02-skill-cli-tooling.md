...
agent 调 `agent-center request-input` 时，CLI 与 worker daemon 之间走 unix socket，daemon 持 pending map 等中心回应。详见 [04-input-required.md](../scheduling/02-input-required.md) 流程图。
