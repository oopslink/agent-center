...
边界处理见 [WorkerProjectProposal § 4 ProposalReviewService](../architecture/tactical/workforce/03-worker-project-proposal.md) 与 [Worker § 4 WorkerProjectMapping](../architecture/tactical/workforce/01-worker.md)。
...
- 详细流程文档：[workforce/00-overview.md](../architecture/tactical/workforce/00-overview.md)（BC 入口）+ [01-worker.md](../architecture/tactical/workforce/01-worker.md) + [03-worker-project-proposal.md](../architecture/tactical/workforce/03-worker-project-proposal.md)
