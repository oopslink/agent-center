...
| ~~0017~~ | ~~Task 即 Conversation：1:1 绑定~~ | **v2 删除**（vendor 撤回；Conversation v2 模型 → [ADR-0039](drafts/0039-conversation-business-model-v2-unified.md)）|
...
| ~~0021~~ | ~~Issue 即 Conversation：1:1 绑定~~ | **v2 删除**（vendor 撤回；模型 → [ADR-0039](drafts/0039-conversation-business-model-v2-unified.md)）|
| ~~0022~~ | ~~Conversation 不对齐 IM 软件的 channel/thread 层级模型~~ | **v2 删除**（vendor 撤回后 trivial；channel 已升业务一等公民 [ADR-0032](drafts/0032-conversation-channel-as-first-class.md)）|
